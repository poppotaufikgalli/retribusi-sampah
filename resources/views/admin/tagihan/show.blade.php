        ...
        <div class="card mb-4">
            <div class="card-body">
                <form method="POST" action="{{route('pembayaran.'.$next)}}" id="formVerifikasi">
                    ...
                    <input type="text" name="tipe" value="verif">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="row mb-1">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" value="{{isset($data) ? $data->no_tiket : '0'}}" disabled>
                                </div>
                            </div>
                            <div class="row mb-1">
                            ...
                            <div class="row mb-1">
                                <div class="col-sm-9 offset-sm-3">
                                    <div class="d-flex justify-content-between">
                                        ...
                                        <button type="button" class="btn btn-sm btn-danger text-capitalize" onclick="verifikasi(-1)">
