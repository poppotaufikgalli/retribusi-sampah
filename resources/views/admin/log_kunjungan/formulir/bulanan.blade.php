                    ...
                    <div class="card-body">
                        <form method="POST" action="{{route('pembayaran.'.$next)}}" enctype="multipart/form-data">
                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-sm-9">
                                    <div class="input-group">
                                        <input type="text" id="snama" class="form-control form-control-sm" value="{{isset($data) ? $data->objek_retribusi?->nama : ''}}" disabled>
                                        <input type="text" id="snama" class="form-control form-control-sm" value="{{isset($data) ? $data->objek_retribusi?->jenis_retribusi?->nama : ''}}" disabled>
                                    </div>
                                </div>
                            </div>
                            <hr>
                            ...
                            <div class="row mb-1">
                                ...
                                @if(isset($karcis))
                                    @if(count($karcis) > 0)
                                        <div class="col-sm-9">
                                            <div class="input-group input-group-sm">
                                                <input type="text" class="form-control form-control-sm" id="no_karcis" name="no_karcis" value="{{old('no_karcis')}}">
                                                <input type="hidden" class="form-control form-control-sm" id="id_karcis" name="id_karcis" value="{{old('id_karcis')}}">
        ...
        <div class="modal fade" id="modalTiket" tabindex="-1" aria-labelledby="modalTiket" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="table-responsive">
                            <table class="table w-100 table-sm small table-stiped table-sm" id="datatablesTiket">
                                <thead class="table-dark text-center">
                                    <tr>
                                        <th>ID</th>
                                        <th>Nomor Karcis</th>
                                    ...
                                    @if(isset($karcis))
                                        @foreach($karcis as $key => $value)
                                            <tr>
                                                ...
                                                <td class="text-center">{{$value->no_karcis_pembayaran}}</td>
        ...
        window.addEventListener('DOMContentLoaded', event => {
            ...
            if (datatablesWp) {
                ...
                table.on('click', 'tbody tr', function () {
                    ...
                    window.location.href = '/pembayaran/create/bulanan/'+data[0]
                });
            }
            ...
            if (datatablesTiket) {
                ...
                tableA.on('click', 'tbody tr', function () {
                    ...
                    document.getElementById('no_karcis').value = data[3]
                    document.getElementById('id_karcis').value = data[0]
