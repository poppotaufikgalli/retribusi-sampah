...
<body>
    @if($data)
        ...
        <div style="width: 100%; text-align: center;">
            <h2 style="text-decoration: underline;">TANDA TERIMA PENGEMBALIAN</h2>
            <p>Nomor : </p>
                ...
                <tbody>
                    ...
                    @foreach($data as $key => $value)
                        <tr>
                            ...
                            <td>{{$value['tgl_pengembalian']->format('d-m-Y')}}</td>
                        </tr>
                        @php($no++)
                        @php($koord[] = $value['nama_koordinator'])
                        @php($jungut[] = $value['nama_juru_pungut'])
                    @endforeach
                </tbody>
